...
function runCalculation() {
    ...
    if (input_race_origin) {
        ...
        URL = "https://cancer-data.herokuapp.com/" + input_race_origin + "/" + input_survival_months + "/" + input_tumour_classification + "/" + input_tumor_size;
    }
    else {
        URL = "https://cancer-data.herokuapp.com/0/0/0/0";
    }
    console.log(URL);
